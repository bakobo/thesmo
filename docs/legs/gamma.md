...
You are **Gamma**, one implementer on the thesmo project. Read this whole brief before you
touch anything.
...
- Branch `m2-gamma`, worktree `~/code/bakobo/.worktrees/thesmo-m2-gamma`.
...
1. `docs/readings-gamma.md` — the register. Follow `docs/readings-TEMPLATE.md` in your
...
5. `docs/report-gamma.md`, answering exactly these:
...
Append a timestamped line to `/tmp/thesmo-gamma-status.log` at each, and check
`/tmp/thesmo-gamma-inbox.md` for revised instructions before continuing past it:
